...
class FOA:
    def __init__(self, fun=Cluster(), numSedds=30, maxTime=1000, lifeTime=2, areaLimit=30, localMotion=1, localSeeding=4,transferRate=4, globalSeeding=2):
        self._fun = fun
    ...
    def update(self,i, scat=None):
        ...
        if scat!=None:
            scat.set_offsets(self._fun.getDatas())
            scat.set_array(np.array([1/round(i) for i in self._best[0:self._dim]]))
